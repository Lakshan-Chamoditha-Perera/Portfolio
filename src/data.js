const PORTFOLIO_DATA = {
  ...
  linkedin: 'https://www.linkedin.com/in/lakshan-perera/',
  github: 'https://github.com/lakshanperera',

  focus: ['#SpringBoot', '#Microservices', '#NextJS', '#Fintech', '#RESTAPIs', '#Security', '#Kafka', '#AWS'],
  ...
  projects: [
    {
      ...
      tech: ['Next.js 15', 'Express.js', 'Prisma', 'PostgreSQL', 'Python', 'Flask', 'Scikit-learn', 'Docker'],
    },
    {
      ...
      tech: ['Java 21', 'Spring Boot 3', 'Spring Cloud', 'Eureka', 'MySQL', 'JWT', 'BCrypt'],
    },
    {
  ...
  skills: [
    { group: 'Languages',       items: ['Java (Primary)', 'JavaScript', 'TypeScript', 'Python'] },
    { group: 'Frameworks',      items: ['Spring Boot', 'Spring Cloud', 'Spring Security', 'Spring Data JPA', 'React.js', 'Next.js', 'Express.js', 'TanStack Query', 'Redux', 'Flask', 'Tailwind CSS'] },
    { group: 'Databases & ORM', items: ['MySQL', 'PostgreSQL', 'MongoDB', 'Hibernate (JPA)', 'Prisma ORM'] },
    { group: 'Testing',         items: ['JUnit 5', 'Mockito', 'Playwright'] },
    { group: 'Messaging',       items: ['Apache Kafka', 'MQTT'] },
    { group: 'Cloud & DevOps',  items: ['AWS', 'Docker', 'CI/CD', 'GitHub Actions'] },
    { group: 'Version Control', items: ['Git', 'GitHub', 'GitLab', 'Bitbucket'] },
    { group: 'Architecture',    items: ['Microservices', 'Micro Frontends', 'Event-Driven Systems', 'RESTful API Design', 'JWT Auth', 'RBAC', 'AES-256 Encryption'] },
  ],

  education: [
    { deg: 'BSc (Hons) Software Engineering',          school: 'Cardiff Metropolitan University',         note: 'Second Class Upper Division', year: '2025' },
    { deg: 'Graduate Diploma in Software Engineering', school: 'Institute of Software Engineering (IJSE)', note: '',                           year: '2024' },
    { deg: 'Diploma in Software Engineering',          school: 'Developers Stack Academy',                note: '',                           year: '2024' },
  ],

  certs: [
    { name: 'Next.js: Build Dynamic, Fast & Scalable Web Applications', issuer: 'LinkedIn Learning' },
    { name: 'Learning Spring 6 with Spring Boot 3',                     issuer: 'LinkedIn Learning' },
    ...
    { name: 'Java Essential Training: Objects and APIs',                issuer: 'LinkedIn Learning' },
    { name: 'Learning Amazon Web Services (AWS) for Developers',        issuer: 'LinkedIn Learning' },
  ],
};
